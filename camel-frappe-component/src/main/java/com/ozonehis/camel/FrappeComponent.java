...
public class FrappeComponent extends AbstractApiComponent<FrappeApiName, FrappeConfiguration, FrappeApiCollection> {
    ...
    protected Endpoint createEndpoint(
            String uri, String methodName, FrappeApiName apiName, FrappeConfiguration endpointConfiguration) {
        ...
        if (endpointConfiguration.equals(this.configuration)) {
            synchronized (this) {
                if (this.frappeClient == null) {
                    this.frappeClient = FrappeClientBuilder.newClient(
            ...
            if (endpointConfiguration.getFrappeClient() != null) {
                ...
                return FrappeClientBuilder.newClient(
                                endpointConfiguration.getBaseApiUrl(),
                                endpointConfiguration.getUsername(),
                                endpointConfiguration.getPassword())
                        .build();
