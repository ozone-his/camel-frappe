...
public class FrappeConfiguration {
    ...
    @UriParam(
            label = "advanced",
            description =
                    "References a user-defined com.ozonehis.camel.frappe.sdk.api.FrappeClient. This option is mutually exclusive to the baseApiUrl, username, password, and personalAccessToken options")
