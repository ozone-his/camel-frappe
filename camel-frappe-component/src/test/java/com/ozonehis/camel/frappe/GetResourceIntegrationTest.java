...
public class GetResourceIntegrationTest extends AbstractFrappeTestSupport {
	...
	private static final String PATH_PREFIX = FrappeApiCollection.getCollection().getApiName(FrappeGetApiMethod.class).getName();
	...
	public void shouldGetResourceWithAnyDocTypeAndFields() {
		...
		var fields = List.of("customer_name", "customer_type", "territory", "customer_group", "customer_primary_contact");
