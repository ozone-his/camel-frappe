...
public class FrappeComponentConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, ExtendedPropertyConfigurerGetter {
    ...
    private com.ozonehis.camel.FrappeConfiguration getOrCreateConfiguration(FrappeComponent target) {
        if (target.getConfiguration() == null) {
            target.setConfiguration(new com.ozonehis.camel.FrappeConfiguration());
        }
    ...
    public boolean configure(CamelContext camelContext, Object obj, String name, Object value, boolean ignoreCase) {
        FrappeComponent target = (FrappeComponent) obj;
